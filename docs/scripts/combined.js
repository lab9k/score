...
(function(t, n) {
                ...
                : (n = yf.exec(t))
                  ...
                  : (n = mf.exec(t))
                    ...
                    : (n = xf.exec(t))
                      ...
                      : bf.hasOwnProperty(t)
                        ? At(bf[t])
                        : "transparent" === t ? new Rt(NaN, NaN, NaN, 0) : null
    );
  }
  function At(t) {
  ...
  function Ln(t, n) {
    ...
    return ("number" == typeof n
      ? an
      : n instanceof Et ? Hf : (e = Et(n)) ? ((n = e), Hf) : sn)(t, n);
  }
  function qn(t, n, e, r) {
  ...
  function Hn(t) {
    return (t = +t) < Ll
      ...
      : t < Dl
        ? Hl * (t -= ql) * t + Ul
        : t < Fl ? Hl * (t -= Ol) * t + Il : Hl * (t -= Yl) * t + Bl;
  }
  function jn(t, n) {
      ...
      function o() {
        ...
        d < s &&
          ...
          (A[0][0] === s && A[0][1] === h && A[1][0] === d && A[1][1] === g) ||
            ((S.selection = [[s, h], [d, g]]), r.call(w), U.brush());
      }
      function u() {
  ...
  function hi() {
    ...
    return (
      ...
      t
        .extentMajor([[-180, -90 + Mp], [180, 90 - Mp]])
        .extentMinor([[-180, -80 - Mp], [180, 80 + Mp]])
    );
  }
  function pi(t) {
    return t;
  ...
  function Zi(t) {
    function n() {
      ...
      return s(
        null == f
          ? [[u[0] - n, u[1] - n], [u[0] + n, u[1] + n]]
          : t === Wi
            ? [[Math.max(u[0] - n, f), e], [Math.min(u[0] + n, r), i]]
            : [[f, Math.max(u[1] - n, e)], [r, Math.min(u[1] + n, i)]]
      );
    }
    var e,
      r,
  ...
  function Eu() {
    ...
    return (
      ...
      (t.invertExtent = function(t) {
        ...
        return n < 0
          ? [NaN, NaN]
          : n < 1 ? [e, o[0]] : n >= i ? [o[i - 1], r] : [o[n - 1], o[n]];
      }),
      (t.copy = function() {
        return Eu()
          .domain([e, r])
  ...
  var Qp,
    ...
    qd = {
      ...
      result: function() {
        var t = Ld
          ? [Pd / Ld, Rd / Ld]
          : zd ? [Ad / zd, Cd / zd] : Ed ? [kd / Ed, Sd / Ed] : [NaN, NaN];
        ...
        (t.thresholds = function(n) {
          return arguments.length
            ? ((r =
                "function" == typeof n
                  ? n
                  : Array.isArray(n) ? c(Ys.call(n)) : c(n)),
              t)
            : r;
        }),
        t
      ...
      return (
        (t.invert = function(t) {
          ...
          return (i >= 0.12 && i < 0.234 && r >= -0.425 && r < -0.214
            ? s
            : i >= 0.166 && i < 0.234 && r >= -0.214 && r < -0.115 ? f : c
          ).invert(t);
        }),
        (t.stream = function(t) {
          return e && r === t
